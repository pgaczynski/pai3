...
use PAI\ParcelBundle\Form\ParcelType;
...
class ParcelFormHandler implements ParcelFormHandlerInterface
{
    ...
    private function processForm(ParcelInterface $parcel, array $parameters,
                                 $method = "PUT")
    {
        $form = $this->formFactory->create($this->formType, $parcel,
            array('method' => $method));
